...
//extern double start;
// In tools.h
//extern double startWallTime;
//extern double startCpuTime;
//extern double start;



//extern std::chrono::high_resolution_clock::time_point startWallTime;
//extern std::chrono::high_resolution_clock::time_point startCpuTime;
