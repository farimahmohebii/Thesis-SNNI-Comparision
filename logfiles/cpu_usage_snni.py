...
metric_of_interest = 'Average CPU usage (%)'
...
for snni, benchmarks in csv_files.items():
    ...
    plt.title(f'{snni} - Average CPU Usage for Client in Different Benchmarks')
    ...
    plt.savefig(f'{snni}_average_cpu_usage_per_benchmark.jpeg', format='jpeg')
    plt.close()
